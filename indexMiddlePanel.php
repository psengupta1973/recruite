		...
		<table  border="0" cellpadding="0" bgcolor='#6699CC' cellspacing="1" width="100%">
			<tr>
			  <td>
				...
				<table cellspacing="0" border="0" cellpadding="2"  width="100%" bgcolor='#DDEEFF'>
					<tr>
					<?php
						for($i=0; $i<$count; $i++)
						{
							...
							echo "<td valign='top' width='20%' class='text'><a href='index.php?subSelected=jobSearch'>".$companies[$i]->getName()."</a></td>\n";
						}
					?>
					</tr>
				</table>
