   ...
   <tr>
	  <td>
		<table cellspacing="0" border="0" cellpadding="2" width="100%">
		  ...
		  <table cellspacing="0" border="0" cellpadding="2" bgcolor="#DDEEE4"  width="100%" align='left'>
			<?php
				for($i=0; $i<$count; $i++)
				{
...
<table cellspacing="1" border="0" cellpadding="0" width="100%" bgcolor="#800000">
	<tr><td>
	  <table cellspacing="0" border="0" cellpadding="1" bgcolor="#FDF4B5"  width="100%" align='left'>
		...
		<tr><td class='text'><a href='abcCompany.php'><font color='#800000' size='2'>Click here for details</font></a></td></tr>
	  </table>
  </td></tr>
</table>
