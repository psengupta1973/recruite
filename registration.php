			...
			<tr>
			  <td width='80%'>
				<table cellspacing="2" border="0" cellpadding="0" width='100%' bgcolor='#6699CC'>
					<tr align='left'>
						<td class="bluebandheading1">Registration</td>
					</tr>
				</table>
				<table cellspacing="0" border="0" cellpadding="2" width="100%">
					<form method="POST" action="saveUser.php" name="registrationForm">
					<tr bgcolor='#EFEFEF'>
						<td>&nbsp;</td>
...
?>
					...
					<tr>
					   ...
					   <td align='left'>
<?php 
					   echo "<input class='TextBox' type='text' name='lname' size='30' value=''>\n";
?>
					   </td>
...
?>
					...
					<tr>
					   ...
					   <td align='left'>
<?php 
					   echo "<input class='TextBox' type='text' name='url' size='30' value=''>\n";
?>
					   </td>
					   <td align="left">&nbsp;</td>
